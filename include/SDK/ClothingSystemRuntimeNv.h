...
public:
	...
	unsigned char                                      UnknownData03_6[0x3];                                       // 0x0141   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData05_7[0x4];                                       // 0x019C   (0x0004)  MISSED
};
...
public:
	...
	// void SetAnimDriveDamperStiffness(float InStiffness);                                                                     // [0x568d650] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
