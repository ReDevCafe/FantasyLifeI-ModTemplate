...
public:
	...
	// void UpdateTickWhenPaused(bool NewTickWhenPaused);                                                                       // [0x7f9be10] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.UpdateNiagaraSystemReference
	// void UpdateNiagaraSystemReference(class UNiagaraSystem* NewNiagaraSystem);                                               // [0x7f9bd80] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.SetRemapMaterial
	// void SetRemapMaterial(class UMaterialInterface* OriginalMaterial, class UMaterialInterface* RemapMaterial);              // [0x7f9bcb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.SetDesiredWidgetSize
	// void SetDesiredWidgetSize(FVector2D NewDesiredSize);                                                                     // [0x7f9bc20] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.SetColorAndOpacity
	// void SetColorAndOpacity(FLinearColor InColorAndOpacity);                                                                 // [0x7f9bb90] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.GetRemapMaterial
	// class UMaterialInterface* GetRemapMaterial(class UMaterialInterface* OriginalMaterial);                                  // [0x7f9baf0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.GetNiagaraComponent
	// class UNiagaraUIComponent* GetNiagaraComponent();                                                                        // [0x7f9bac0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.DeactivateSystem
	// void DeactivateSystem();                                                                                                 // [0x7f9baa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.ActivateSystem
	// void ActivateSystem(bool Reset);                                                                                         // [0x7f9ba10] Final|Native|Public|BlueprintCallable 
};
