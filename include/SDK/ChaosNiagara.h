...
/// Size: 0x0348 (840 bytes) (0x000038 - 0x000348) align 8 MaxSize: 0x0348
...
public:
	...
	unsigned char                                      UnknownData03_6[0x2];                                       // 0x0126   (0x0002)  MISSED
	...
	unsigned char                                      UnknownData05_6[0x7];                                       // 0x0151   (0x0007)  MISSED
	...
	unsigned char                                      UnknownData06_6[0x1];                                       // 0x016F   (0x0001)  MISSED
	...
	unsigned char                                      UnknownData09_6[0x3];                                       // 0x022D   (0x0003)  MISSED
	FVector2D                                          RandomVelocityMagnitudeMinMax;                              // 0x0230   (0x0010)  
	float                                              SpreadAngleMax;                                             // 0x0240   (0x0004)  
	unsigned char                                      UnknownData10_6[0x4];                                       // 0x0244   (0x0004)  MISSED
	...
	unsigned char                                      UnknownData11_6[0x3];                                       // 0x028D   (0x0003)  MISSED
	int32_t                                            LastSpawnedPointID;                                         // 0x0290   (0x0004)  
	float                                              LastSpawnTime;                                              // 0x0294   (0x0004)  
	unsigned char                                      UnknownData12_6[0x10];                                      // 0x0298   (0x0010)  MISSED
	float                                              SolverTime;                                                 // 0x02A8   (0x0004)  
	float                                              TimeStampOfLastProcessedData;                               // 0x02AC   (0x0004)  
	unsigned char                                      UnknownData13_7[0x98];                                      // 0x02B0   (0x0098)  MISSED
};
