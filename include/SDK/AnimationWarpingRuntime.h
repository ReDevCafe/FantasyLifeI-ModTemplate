...
public:
	...
	// FTransform GetOffsetRootTransform(FAnimNodeReference& Node);                                                             // [0x7e5cbe0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimationWarpingRuntime.AnimationWarpingLibrary.GetCurveValueFromAnimation
	// bool GetCurveValueFromAnimation(class UAnimSequenceBase* Animation, FName CurveName, float Time, float& OutValue);       // [0x7e5c990] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
