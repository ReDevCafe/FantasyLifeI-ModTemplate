...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect(class UMeshComponent* meshComp);                                              // [0x7a11280] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// float GetNotifyProgress(class UMeshComponent* meshComp);                                                                 // [0x7a111e0] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect();                                                                            // [0x57a0970] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
